		...
		<View style={styles.container}>
				...
				<View>
					...
					<View style={styles.labelContainer}>
						{cautions.map((caution, index) => (
							<Text key={caution} style={styles.labelPillCaution}>
								{caution}
							</Text>
						))}
					</View>
			...
			<View>
				...
				<View>
					<DataTable>
						<DataTable.Header>
							<DataTable.Title textStyle={{ width: '100%', fontWeight: '800', fontSize: 20 }}>
								Label
							</DataTable.Title>
							<DataTable.Title
								textStyle={{
						...
						{nutrientArray
							...
							.map((item) => (
								<DataTable.Row key={item.nutrientCode}>
									...
									<DataTable.Cell numeric>{item.quantity.toFixed()}</DataTable.Cell>
								</DataTable.Row>
							))}
					</DataTable>
				</View>
